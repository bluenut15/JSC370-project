...
The data for this analysis was obtained from multiple sources using API queries and online databases. The suicide rates data was retrieved from the World Health Organization (WHO) API, providing annual crude suicide rates per 100,000 population for countries worldwide from 2000 to 2021. The API response was filtered to include only aggregate data for both sexes and all age groups. The alcohol expenditure data was also extracted from the WHO API, containing annual alcohol expenditure as a percentage of total household expenditure from 1990 to 2017. The GDP per capita data was downloaded from Our World in Data, which sourced the dataset from the World Bank’s World Development Indicators in 2025. The dataset was restricted to records from 1990 to 2023. The Gini index data was downloaded from Our World in Data, with data originally retrieved from the World Bank’s Poverty and Inequality Platform in 2024. This dataset provides the annual Gini coefficient for countries worldwide from 1963 to 2023.
...
The final merged dataset contains 267 observations on the variables year, suicide rates, GDP per capita, Gini index, and alcohol spending percentage.
